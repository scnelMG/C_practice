...
{
	// 배열
	/*int subway_1 = 30; // 지하철 1호차에 30명이 타고 있음
	int subway_2 = 40;
	int subway_3 = 50;
	...
	//문자열 // 문자열 끝에는 '끝'을 의미하는 NULL 문자 '\0'가 포함되어야 함
	/*char str[6] = "coding";
	printf("%c\n", str);*/
	...
	/*char str[] = "coding"; //문자열 끝에는 '끝'을 의미하는 NULL 문자 '\0'가 자동으로 포함됨
	printf("%s\n", str);
	printf("%d\n", sizeof(str));
	...
	/*char kor[] = "오병민";
	printf("%s\n", kor);
	printf("%d\n", sizeof(kor));*/ // 한글 3글자 * 2 + null문자(1) = 7
	// 영어 1글자 : 1 byte
	// 한글 1글자 : 2 byte
	...
	// 참고 : ASKII 코드? 미국 표준협회(ANSI) 에서 제시한 코드 체계
	// 7bit, 총 128개 콛, (0~127)
